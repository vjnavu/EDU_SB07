...
function ZoomImage(tabNum) {
  this.container = QS('.page_' + tabNum).querySelector('.zoomContainer')
  ...
  this.zoomController = createElement('div', this.container, 'zoomController');
...
// drag
function Drag(args) {
  this.zoomImg = QS('.page_' + args.tabNumm + ' .zoomImgContainer');
  this.option = args;
