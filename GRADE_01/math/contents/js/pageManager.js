...
$ts.loadScriptFile("../math/libs/js/polyfills.js"),
    function() {
        var t = $ts.ce({
                tag: "div",
                class: "loadingImage",
        ...
        window.parent == window ? (console.log("[  Run Contents Mode(no UI)  ]"), document.querySelector("html").classList.add("noUI"), $ts.loadScriptFile("../math/libs/js/scale.js", function() {
        ...
        function n() {
            $ts.loadScriptFile("../math/libs/js/drag.js", function() {
            ...
            }), $ts.getEl("[drag]") && $ts.loadScriptFile("../math/content/js/simpleDrag.js");
            ...
            }), $ts.getEl("[data-zoom-container]") && $ts.loadScriptFile("../math/libs/js/zoomImage.js", function() {
        ...
        g.inPageReset = function() {
            ...
            for (var t in f.inPopup) {
                if (f.inPopup[t].length) {
                     for (var e in f.inPopup[t]) {
                        g.reset(f.inPopup[t][e], t);
                     }
                }
            }
        ...
        function() {
            window.$efSound = {};
            var n = {
                click: $ts.createAudio.set("../math/libs/media/click.mp3"),
                correct: $ts.createAudio.set("../math/libs/media/correct.mp3"),
                incorrect: $ts.createAudio.set("../math/libs/media/incorrect.mp3"),
                wrong: $ts.createAudio.set("../math/libs/media/wrong.mp3"),
                checkSound: $ts.createAudio.set("../math/libs/media/checkSound.mp3"),
                clap: $ts.createAudio.set("../math/libs/media/clap.mp3"),
                animation: $ts.createAudio.set("../math/libs/media/animationBG.mp3")
            };
