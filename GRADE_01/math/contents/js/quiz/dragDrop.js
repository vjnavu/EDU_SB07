    ...
    var i = "dragObjComplete",
        e = function() {
            ...
            return _createClass(r, [{
                ...
                value: function() {
                    var e = this;
                    window.$callBack.sliderMove || (window.$callBack.sliderMove = function() {
                ...
                value: function(e, t) {
                    ...
                    this.TOTAL_COUNT++, this.QUIZ.option.copy || (n.disable(!0), r.dragObjCompleteClass(n, !0)), this.copyObj(), r.completeArea(a), this.checkTotalComplete()
                }
            }, {
                key: "endWrong",
                value: function() {
                ...
                value: function() {
                    ...
                    e.forEach(function(t) {
                        a.forEach(function(e) {
                            n.checkAnswers(t, e) && (r.dropAreaHasCopied(t, e) || (n.copyObj(t, e), r.dragObjCompleteClass(t, !0))), e.disable(!0)
                        }), t.disable(!0)
                    })
                }
            }, {
                ...
                value: function() {
                    ...
                    t && t.dataset.option && -1 < t.dataset.option.indexOf("resetOnly") && t.classList.add("reset"), this.TOTAL_COUNT = 0, this.resetAreas(), this.resetObjs(), e.initDragObjsCoords(), e.setZoomRate()
                }
            }, {
                key: "resetObjs",
                value: function() {
                ...
                value: function() {
                    this.game.dropAreas.forEach(function(e) {
                        for (var t, n = e.element.querySelectorAll(".".concat(i)), a = 0, o = n.length; a < o; a++) t = n[a], e.element.removeChild(t);
                        e.disable(!1)
                    })
                }
            }, {
                ...
                value: function() {
                    console.log("checkTotalComplete ".concat(this.TOTAL_COUNT, " : ").concat(this.TOTAL_COMPLETE_COUNT)), this.TOTAL_COUNT === this.TOTAL_COMPLETE_COUNT && (console.log("끝!")
                    , this.QUIZ.toggleAnswerBtn()
                    )
                }
            }, {
                ...
                get: function() {
                    this.game.container;
                    var e = this.game.container.element.hasAttribute("data-total-complete-count") && this.game.container.element.getAttribute("data-total-complete-count"),
                        e = parseInt(e);
                ...
                value: function(e) {
                    ...
                    n && o ? (a.endCorrect(), window.$efSound.correct()) : (a.endWrong(), window.$efSound.incorrect())
                }
            }, {
                ...
                value: function(e) {
                    var t = e,
                        ...
                        o = t.element.querySelectorAll(".js-dragObj") && t.element.querySelectorAll(".js-dragObj").length || 0;
                    n && a === o && t.disable(!0)
                }
            }, {
                key: "getCompleteCnt",
                ...
                value: function(e, t) {
                    ...
                    const _wrap = n.closest('[data-quiz="dragDrop"]');
                    console.log(n,_wrap)

                    if (!!_wrap && !t) {
                        const _areas = _wrap.querySelectorAll('.js-dropArea');
                        for (let item of _areas) {
                            const items = item.querySelectorAll('.js-dragObj');
                            
                            for(let _item of items) {
                                _item.remove();
                            }
                        }
                        console.log('삭제',DragObj);
                    }
