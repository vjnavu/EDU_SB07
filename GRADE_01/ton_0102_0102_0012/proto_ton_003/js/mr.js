window.addEventListener("load", () => {
    ...
    const measureArr = [
        [
            6, 0.6, 0.3, 0.2, 0.2, 0.7, 0.3, 0.3, 0.3, 0.3, 0.5, 0.3, 1.5
        ],
        [
            0.6, 0.3, 0.2, 0.2, 0.7, 0.3, 0.3, 0.3, 0.3, 0.5, 0.3, 1.5
        ],
        [
            0.3, 0.2, 0.3, 0.3, 0.3, 0.3, 1, 0.3, 0.2, 0.3, 0.3, 0.3, 0.3, 1.3
        ],
        [
            0.2, 0.3, 0.3, 0.3, 0.5, 0.2, 0.2, 0.3, 0.3, 0.5, 0.2, 0.2, 0.2, 0.2, 0.3, 0.3, 1.5
        ],
        [
            0.6, 0.3, 0.2, 0.2, 0.7, 0.3, 0.3, 0.3, 0.3, 0.5, 0.3, 1.5
        ],
    ...
    if (measuresData == 5) {
        ...
        for (i = 0; i < length; i += 5) {
            measuresGroup.slice(i, i + 5).wrapAll('<div class="sheet-group"></div>');
        }
    }
    ...
    */
    function showCurrentLyrics(idx) {
        ...
        } else if (measuresData == 3) {
            sheetGroups[Math.floor(idx / 3)].classList.add("on");
        } else if (measuresData == 4) {
            sheetGroups[Math.floor(idx / 4)].classList.add("on");
        } else if (measuresData == 5) {
            sheetGroups[Math.floor(idx / 5)].classList.add("on");
        }
    ...
    */
    ...
    setInterval(() => {
        ...
        if (isPlaying && 3 <= audio.currentTime && audio.currentTime <= 6) {
            ++countVar;
    ...
    function btnPitchDownHandler() {
        ...
        if (isPlaying) {
            if (this.classList.contains("active")) {
                ...
                audio.setAttribute("src", "./media/mr.mp3");
                ...
                audio.pause();
                const stopTime = audio.currentTime;
                audio.setAttribute("src", "./media/mr_down.mp3");
                audio.currentTime = stopTime;
