    ...
    function btnPitchDownHandler() {
        ...
        if (isPlaying) {
            if (this.classList.contains("active")) {
                ...
                audio.setAttribute("src", "../../media/proto_ton_004/mr.mp3");
                ...
                audio.pause();
                const stopTime = audio.currentTime;
                audio.setAttribute("src", "../../media/proto_ton_004/mr_down.mp3");
                audio.currentTime = stopTime;
    ...
    function btnPitchUpHandler() {
        ...
        if (isPlaying) {
            if (this.classList.contains("active")) {
                ...
                audio.pause();
                const stopTime = audio.currentTime;
                audio.src = "../../media/proto_ton_004/mr.mp3";
                audio.currentTime = stopTime;
                audio.play();
            } else {
                this.classList.add("active");
                audio.pause();
                const stopTime = audio.currentTime;
                audio.src = "../../media/proto_ton_004/mr_up.mp3";
                audio.currentTime = stopTime;
                audio.play();
            }
        } else {
