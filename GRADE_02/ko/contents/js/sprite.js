    ...
    var y = {
        ...
        add: function (L) {
            ...
            this.initSpriteListObj(h), 0 < L.spriteList.length ? L.spriteList.forEach(function (r, e) {
                ...
                // console.log(w.parentElement.id);
                // Set character-item postition 2024-04-25
                w.parentElement.style.bottom = r.bottom + "px";
                w.parentElement.style.left = r.left + "px";


                r.speech && w.classList.add('speech');
                r.speech && w.classList.add(r.speech);

                // Not set position for characterWrap 2024-04-25
                ...
                // characterImg > charSpriteImg | charSpriteAni
                var t = $ts.ce({
                    tag: "div",
                    class: "characterImg",
                    parent: w
                ...
                if (a.style.backgroundImage = "url(" + r.spriteSheet + ")", a.style.width = r.width + "px", a.style.height = r.height + "px", a.setAttribute("data-idx", dataIdx), y.isChrome && (a.style.opacity = 0), y.spriteList[h].characterList.push(t), y.spriteList[h].sheetList.push(a), y.spriteList[h].thumbNailList.push(n), r.textBubble) {
                    var i = $ts.ce({
                        tag: "div",
                    ...
                    // VTA 2024-06-03 added
                    i.setAttribute("data-idx", dataIdx);
                ...
                a_wrap.addEventListener("click", function (e) {
                    ...
                    if (e.preventDefault(), y.currentSpriteId = h, y.originalSpriteList = L.spriteList, _this.classList.contains("waiting")) {
                        ...
                        var s = document.querySelector('.balloon[data-idx="' + t + '"]');
        ...
        allresetSprite: function () {
            this.resetSprite(), y.currentSpriteId && y.originalSpriteList.forEach(function (e) {
        ...
        spriteList: [
            {
                ...
                width: 205,
                height: 293,
                thumbNail: '../ko/contents/images/character/boy_1.png',
                spriteSheet: '../ko/contents/images/character/boy_1_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC pink fff ' + opt.class,
                    top: opt.balloon_top,
                    left: opt.balloon_left,
                    width: 'max-content',
                    textAlign: 'center',
                    wordBreak: 'keep-all'
                },
        ...
        spriteList: [
            {
                ...
                width: 198,
                height: 293,
                thumbNail: '../ko/contents/images/character/boy_2.png',
                spriteSheet: '../ko/contents/images/character/boy_2_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC yellow fff ' + opt.class,
                    top: opt.balloon_top,
                    left: opt.balloon_left,
                    width: 'max-content',
                    textAlign: 'center',
        ...
        spriteList: [
            {
                ...
                width: 188,
                height: 293,
                thumbNail: '../ko/contents/images/character/boy_3.png',
                spriteSheet: '../ko/contents/images/character/boy_3_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC purple fff ' + opt.class,
                    top: opt.balloon_top,
                    left: opt.balloon_left,
                    width: 'max-content',
                    textAlign: 'center',
        ...
        spriteList: [
            {
                ...
                width: 207,
                height: 293,
                thumbNail: '../ko/contents/images/character/boy_4.png',
                spriteSheet: '../ko/contents/images/character/boy_4_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC green fff ' + opt.class,
                    top: opt.balloon_top,
                    left: opt.balloon_left,
                    width: 'max-content',
                    textAlign: 'center',
        ...
        spriteList: [
            {
                ...
                width: 227,
                height: 293,
                thumbNail: '../ko/contents/images/character/girl_1.png',
                spriteSheet: '../ko/contents/images/character/girl_1_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC pink fff ' + opt.class,
        ...
        spriteList: [
            {
                ...
                width: 199,
                height: 293,
                thumbNail: '../ko/contents/images/character/girl_2.png',
                spriteSheet: '../ko/contents/images/character/girl_2_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC purple fff ' + opt.class,
        ...
        spriteList: [
            {
                ...
                width: 204,
                height: 293,
                thumbNail: '../ko/contents/images/character/girl_3.png',
                spriteSheet: '../ko/contents/images/character/girl_3_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC yellow fff ' + opt.class,
        ...
        spriteList: [
            {
                ...
                width: 190,
                height: 310,
                thumbNail: '../ko/contents/images/character/girl_4.png',
                spriteSheet: '../ko/contents/images/character/girl_4_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC green fff ' + opt.class,
        ...
        spriteList: [
            {
                ...
                width: 211,
                height: 320,
                thumbNail: '../ko/contents/images/character/rabbit.png',
                spriteSheet: '../ko/contents/images/character/rabbit_sprite.png',
                sound: opt.sound,
                textBubble: {
                    text: opt.text,
                    class: 'balloon textAlignC pink fff ' + opt.class,
...
function callBackEnd() {
    $('.charSpriteAni').removeClass('waiting').css('opacity', '0')
    $('.charSpriteImg').css('opacity', '1');
}